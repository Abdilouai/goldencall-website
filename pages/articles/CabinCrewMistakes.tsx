...
export const CabinCrewMistakes: React.FC = () => {
    const content = (
        <>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">1. Arriving Unprepared</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">2. Poor Grooming Standards</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">3. Not Being a Team Player</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">4. Weak Body Language</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">5. Generic Answers to Questions</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">Final Thoughts</h2>
            <p>
            ...
            <div className="bg-card border-l-4 border-primary p-6 my-8 rounded-r-lg shadow-sm">
                <h3 className="font-heading font-bold text-xl mb-2 text-text">Need Personalized Guidance?</h3>
