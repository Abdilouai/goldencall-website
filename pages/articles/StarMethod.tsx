...
export const StarMethod: React.FC = () => {
    const content = (
        <>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">What is the STAR Method?</h2>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">Breaking Down STAR</h2>

            <h3 className="text-2xl font-heading font-semibold mt-8 mb-4 text-text">S - Situation</h3>
            <p>
            ...
            <h3 className="text-2xl font-heading font-semibold mt-8 mb-4 text-text">T - Task</h3>
            <p>
            ...
            <h3 className="text-2xl font-heading font-semibold mt-8 mb-4 text-text">A - Action</h3>
            <p>
            ...
            <h3 className="text-2xl font-heading font-semibold mt-8 mb-4 text-text">R - Result</h3>
            <p>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">Common STAR Mistakes to Avoid</h2>
            <ul>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">Practice Questions Using STAR</h2>
            ...
            <h2 className="text-3xl font-heading font-bold mt-12 mb-6 text-text">Final Tips</h2>
            <ul>
            ...
            <div className="bg-card border-l-4 border-primary p-6 my-8 rounded-r-lg shadow-sm">
                <h3 className="font-heading font-bold text-xl mb-2 text-text">Master Your Interview Skills</h3>
