...
export const Payment: React.FC = () => {
    ...
    // Payment Type State: 'local' or 'international'
    ...
    return (
        <div className="min-h-screen py-16 bg-dark">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Block 2: Payment Type Selection (Local vs International) */}
                <h2 className="font-heading font-bold text-2xl text-text mb-6">
                    {t('payment.chooseType', 'Choisir le type de paiement')}
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                    <button
                        ...
                        className={`relative flex flex-col items-center justify-center p-6 rounded-2xl border-2 transition-all w-full
                            ${paymentType === 'local' ? 'bg-primary/5 border-primary shadow-lg shadow-primary/10' : 'bg-card border-border hover:border-primary/50'}
                        `}
                    >
                    ...
                    <button
                        ...
                        className={`relative flex flex-col items-center justify-center p-6 rounded-2xl border-2 transition-all w-full
                            ${paymentType === 'international' ? 'bg-primary/5 border-primary shadow-lg shadow-primary/10' : 'bg-card border-border hover:border-primary/50'}
                        `}
                    >
                        <Globe size={32} className={`mb-3 ${paymentType === 'international' ? 'text-primary' : 'text-text-muted'}`} />
                        <div className="font-heading font-bold text-text mb-1">{t('payment.typeInternational', 'Paiement International')}</div>
                        <div className="font-sans text-xs text-text-muted text-center">{t('payment.typeInternationalDesc', 'Carte Bancaire via Stripe')}</div>
                    </button>
                </div>

                {/* Block 3: Dynamic Content based on Payment Type */}
                {paymentType === 'local' ? (
                    <>
                        <h2 className="font-heading font-bold text-2xl text-text mb-6">
                    ...
                    <div className="bg-card border border-primary/50 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
